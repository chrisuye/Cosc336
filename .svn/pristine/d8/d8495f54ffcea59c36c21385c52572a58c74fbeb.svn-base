...
public class Configuration_RoomList {
    ...
    private void addRoom(Room room) {
     ...
     /** 
     * Iterate through all either rooms or creatures 
     * 
     * @param room The rooms that it can see
     * @param creature The creatures it can see 
     */

     private Object getIterator(Object iterator){
